...
public class PanelAcciones extends JPanel implements ActionListener, MouseListener
{
    ...
    public PanelAcciones( InterfazBiblioteca nPrincipal )
    {
        ...
        labelRegistrarse.setText( "ÀSin cuenta? Registrese" );
    ...
    /**
     * MŽtodo que se ejecuta cuando se hace alguna acci—n sobre los listener del panel.
    ...
    {
        labelRegistrarse.setFont( new Font( "Dialog", Font.BOLD, 10 ) );
        labelRegistrarse.setText( "<html><u>ÀSin cuenta? Registrese</u></html>" );
    }
